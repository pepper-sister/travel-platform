...
export type FetchBoardQuery = {
  __typename?: "Query";
  fetchBoard: { __typename?: "Board"; _id: string; writer?: string | null; title: string; contents: string };
};
...
export type FetchBoardsQuery = {
  __typename?: "Query";
  fetchBoards: Array<{ __typename?: "Board"; _id: string; title: string; writer?: string | null; createdAt: any }>;
};
      ...
      variableDefinitions: [
        {
          ...
          variable: { kind: "Variable", name: { kind: "Name", value: "userboardId" } },
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "userboardId" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "createBoardInput" } },
          type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "CreateBoardInput" } } },
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "createBoardInput" } },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "updateBoardInput" } },
          type: { kind: "NonNullType", type: { kind: "NamedType", name: { kind: "Name", value: "UpdateBoardInput" } } },
        },
        {
          kind: "VariableDefinition",
            ...
            arguments: [
              {
                ...
                value: { kind: "Variable", name: { kind: "Name", value: "updateBoardInput" } },
              },
              {
                kind: "Argument",

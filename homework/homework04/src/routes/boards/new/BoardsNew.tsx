    ...
    <div className="column__sort gap__40">
      ...
      <main className="column__sort gap__40">
        ...
        <div className="column__sort gap__8">
          ...
          <input className="input__text" type="text" placeholder="제목을 입력해 주세요." onChange={onChangeTitle} />
        ...
        <div className="column__sort gap__8">
          ...
          <textarea className="textarea__text" placeholder="내용을 입력해 주세요." onChange={onChangeContent} />

...
export type FetchTravelproductsIPickedQuery = { __typename?: 'Query', fetchTravelproductsIPicked: Array<{ __typename?: 'Travelproduct', name: string, price?: number | null, createdAt: any, seller?: { __typename?: 'User', name: string } | null }> };

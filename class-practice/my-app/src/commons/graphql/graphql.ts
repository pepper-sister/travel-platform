...
export type FetchBoards6QueryVariables = Exact<{
  mypage?: InputMaybe<Scalars['Int']['input']>;
}>;


export type FetchBoards6Query = { __typename?: 'Query', fetchBoards: Array<{ __typename?: 'Board', _id: string, writer?: string | null, title: string, contents: string }> };

export type FetchBoards2QueryVariables = Exact<{ [key: string]: never; }>;


export type FetchBoards2Query = { __typename?: 'Query', fetchBoards: Array<{ __typename?: 'Board', _id: string, writer?: string | null, title: string, likeCount: number }> };
